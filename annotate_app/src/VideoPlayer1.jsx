...
export default function VideoPlayer() {
  ...
  const handlePlay = async () => {
    try {
      await fetch("http://localhost:8000/start-recording", {
        method: "POST",
      });
  ...
  // Measure height after component mounts
  useEffect(() => {
    if (videoContainerRef.current) {
      setVideoHeight(videoContainerRef.current.offsetHeight);
    }
  }, [currVideo]); // remeasure when video changes
      ...
      >
        ...
        <Row className="d-flex justify-content-center align-items-center">
          <Col md={8} lg={6} xs={12}>
            ...
            Arousal - <b>{aro}</b> Valence - <b>{val}</b> ;
          </Col>
        </Row>
        {/* <Row className="d-flex justify-content-center align-items-center">
        ...
        <Row>
          <Col
            ...
            lg={1}
            xs={12}
            className="d-flex flex-column justify-content-between align-items-end pe-0"
            style={{ height: videoHeight || "auto" }}
          >
            <img src="/tag0.png" alt="Tag 0" style={{ width: "80%" }} />
            <img src="/tag2.png" alt="Tag 2" style={{ width: "80%" }} />
          </Col>

          <Col md={8} lg={8} xs={12} ref={videoContainerRef}>
            <ReactPlayer
              url={currVideo}
              playing={playing}
              controls
          ...
          <Col
            ...
            lg={1}
            xs={12}
            className="d-flex flex-column justify-content-between align-items-start ps-0"
            style={{ height: videoHeight || "auto" }}
          >
            <img src="/tag1.png" alt="Tag 1" style={{ width: "80%" }} />
            <img src="/tag3.png" alt="Tag 3" style={{ width: "80%" }} />
          </Col>
        </Row>
        ...
        <Row className="d-flex justify-content-center align-items-center">
          <Col>
            ...
            >
              ...
              {/* Tag image just below canvases */}
              <img
                src="/tag4.png"
                alt="Tag 4"
                // style={{ width: `${canvasWidth}px`, marginTop: '8px' }}
                style={{
                  width: `100px`,
                  marginTop: "8px",
                  marginLeft: "-212px",
